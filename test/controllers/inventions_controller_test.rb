...
class InventionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invention" do
    assert_difference('Invention.count') do
      post inventions_url, params: { invention: { description: @invention.description, title: @invention.title } }
    end
  ...
  test "should update invention" do
    patch invention_url(@invention), params: { invention: { description: @invention.description, title: @invention.title } }
